...
import type { Option, Options, PollNode } from '@/editor/registry/new-york/editor/nodes/poll-node'
import { $isPollNode, createPollOption } from '@/editor/registry/new-york/editor/nodes/poll-node'
