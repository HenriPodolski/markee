...
import { Command, CommandGroup, CommandItem, CommandList } from '@/editor/registry/new-york/ui/command'

import { useEditorModal } from '@/editor/registry/new-york/editor/editor-hooks/use-modal'
import { INSERT_COLLAPSIBLE_COMMAND } from '@/editor/registry/new-york/editor/plugins/collapsible-plugin'
import { EmbedConfigs } from '@/editor/registry/new-york/editor/plugins/embeds/auto-embed-plugin'
import { InsertEquationDialog } from '@/editor/registry/new-york/editor/plugins/equations-plugin'
import { INSERT_EXCALIDRAW_COMMAND } from '@/editor/registry/new-york/editor/plugins/excalidraw-plugin'
...
import { INSERT_PAGE_BREAK } from '@/editor/registry/new-york/editor/plugins/page-break-plugin'
...
import LexicalTypeaheadMenuPlugin from './default/lexical-typeahead-menu-plugin.ts'
