    ...
    <>
          ...
          {Object.entries(workspaceCollections).map(
            ([collectionFolder, collection]) => (
              <Collapsible
                ...
                onOpenChange={() =>
                  toggleExpandCollection(collectionFolder, collection)
                }
              ...
              >
                <SidebarMenuItem>
                  ...
                  <CollapsibleContent>
                    <SidebarMenuSub>
                      {(
                        Object.entries(collectionNotesCallback(collection)) as [
                          string,
                          ConfigStoreNote,
                        ][]
                      ).map(([noteFile, note]) => (
                      ...
                      <SidebarMenuSubItem>
                        <SidebarMenuSubButton
                          onClick={(evt: MouseEvent) =>
                            handleAddNoteClick(evt, collection)
                          }
      ...
      >
        <CollectionUpsertDialog
          setCollectionCreationDialogOpen={setCollectionCreationDialogOpen}
        />
      </Dialog>
